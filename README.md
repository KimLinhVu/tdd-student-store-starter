...
Yes, the labs prepared me to complete the assignment. I felt that there could have been more information on axios though. 

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have worked more on the UI for the Past Orders page/coming up with my own design. I would have also added a login feature where users could log into their account and only view their past orders.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

The overall demo went well, I was able to complete the core and stretch features provided by Codepath.
...
Shoutout to Nicole and Rodrigo for giving me emotional support. 